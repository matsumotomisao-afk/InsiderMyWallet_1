...
namespace MyWallet.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public PaymentTypesController(MyWalletContext context)
        {
            _context = context;
        }
        ...
        {
            if (id != paymentType.PaymentTypeId) return NotFound();
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PaymentTypeExists(paymentType.PaymentTypeId)) return NotFound();
                    else throw;
                }
                return RedirectToAction(nameof(Index));
            }
